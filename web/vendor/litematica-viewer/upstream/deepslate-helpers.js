// ---------------------------------------------------------------------------
// 逐字节副本，来源见 third_party/viewer/UPSTREAM.md
//   上游：Litematica-viewer @ 65f41744eb372c8ffa40e23462fd13cb6168133f
//   script/JSrender/src/deepslate-helpers.js  ->  本文件
//   sha256 = 643df4d16ce1e302...（见 viewer.lock.json；对 CRLF 归一化后的内容计算）
// 定义全局：loadDeepslateResources(textureImage) / deepslateResources / structureFromLitematic。
// 注意：本文件必须用普通 <script> 加载，不能用 type="module"。
// ---------------------------------------------------------------------------
